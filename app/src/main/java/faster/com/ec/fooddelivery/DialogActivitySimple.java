...
public class DialogActivitySimple extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        View view = getLayoutInflater().inflate(R.layout.activity_dialog_simple,null);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.start_compaign_yes){
            ...
            PendingIntent pendingIntent=PendingIntent.getActivity(this,0,
                    dialog,PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);
            try {
                pendingIntent.send();
